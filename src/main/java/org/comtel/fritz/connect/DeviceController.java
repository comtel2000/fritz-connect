...
public class DeviceController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		switchDevice.addListener((observable, olddev, dev) -> {
            ...
            energyLbl.setText(String.format("%d Wh", dev.getEnergy()));
            powerLbl.setText(String.format("%.2f W", dev.getPower() > 0 ? (double) dev.getPower() / 1000 : 0d));
        });
		
		switchCBox.selectedProperty().addListener((observable, oldValue, selected) -> {
